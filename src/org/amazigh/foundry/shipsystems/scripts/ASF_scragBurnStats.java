...
public class ASF_scragBurnStats extends BaseShipSystemScript {

	public static final float SPEED_MULT = 2f; // plus one
	public static final float SPEED_FLAT = 160f;
	public static final float ACCEL_MULT = 3f; // plus one
	public static final float ACCEL_FLAT = 150f;
	public static final float TURN_MALUS = 0.5f;
	
	public static final float ACCEL_MALUS = 0.8f;
	public static final float TURN_BONUS = 2f; // plus one
