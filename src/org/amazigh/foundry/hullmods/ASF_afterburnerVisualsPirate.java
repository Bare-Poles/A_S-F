...
public class ASF_afterburnerVisualsPirate extends BaseHullMod {
	...
	public static final float DAMAGE_REDUCTION_SCALE = 0.15f; // strength scalar for the damper effect
