...
public class ASF_expiationInfo extends BaseHullMod {
	...
	public static final int CHARGE_FLUX_SEC = 600;
	
	public static final int STAGE_1_DAMAGE = 300;
	
	public static final int STAGE_2_DAMAGE_MIN = 2500;
	public static final int STAGE_2_DAMAGE_MAX = 3000;
	
	public static final int STAGE_3_DAMAGE = 3000;
	public static final int STAGE_3_EMP_MIN = 800;
	public static final int STAGE_3_EMP_MAX = 1600;
	public static final int STAGE_3_ARC_DAMAGE = 120;
	public static final int STAGE_3_ARC_EMP = 600;
	
	public static final int STAGE_4_DAMAGE = 4000;
	public static final int STAGE_4_EMP = 1600;
	
	public static final int STAGE_4_ARC_DAMAGE = 200;
	public static final int STAGE_4_ARC_EMP = 800;
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		...
		label = tooltip.addPara("During the second stage of charging, the weapon will fire a single projectile, dealing from %s to %s energy damage.", pad, h, STAGE_2_DAMAGE_MIN + "", STAGE_2_DAMAGE_MAX + " Energy");
		label.setHighlight(STAGE_2_DAMAGE_MIN + "", STAGE_2_DAMAGE_MAX + " Energy");
		label.setHighlightColors(h, h);
		
		tooltip.addSectionHeading("Charge Stage Three", h, STAGE_3_COLOR, Alignment.MID, hpad);
		
		label = tooltip.addPara("During the third stage of charging, the weapon will fire a single projectile, dealing %s and from %s to %s damage.", pad, h, STAGE_3_DAMAGE + " Energy", STAGE_3_EMP_MIN + "", STAGE_3_EMP_MAX + " EMP");
		label.setHighlight(STAGE_3_DAMAGE + " Energy", STAGE_3_EMP_MIN + "", STAGE_3_EMP_MAX + " EMP");
		label.setHighlightColors(h, h, h);
		...
		label.setHighlightColors(h, h);
		label = tooltip.addPara("%s %s %s", pad, h, "Firing a charge stage four shot will convert", "50%", "of the firing ships soft flux into hard flux.");
		label.setHighlight("Firing a charge stage four shot will convert", "50%", "of the firing ships soft flux into hard flux.");
		label.setHighlightColors(bad, h, bad);
